...
input="../../Documents/Textes/Liste_Noms_Textes/Liste_noms_textes.txt"
...
do
    ...
    # iconv -c -f $input_text_encoding -t UTF-8 $text_file_path > $text_file_path2
    #pb de non reconnaissance si on utilise input_text_encoding pour 
